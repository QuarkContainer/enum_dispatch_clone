...
// structures.
lazy_static! {
    static ref TRAIT_DEFS: Mutex<HashMap<UniqueItemId, String>> =
        Mutex::new(HashMap::new());
    static ref ENUM_DEFS: Mutex<HashMap<UniqueItemId, String>> =
        Mutex::new(HashMap::new());
    static ref DEFERRED_LINKS: Mutex<HashMap<UniqueItemId, Vec<UniqueItemId>>> =
        Mutex::new(HashMap::new());
    static ref ENUM_CONVERSION_IMPLS_DEFS: Mutex<HashSet<UniqueItemId>> =
